	...
	<section id="list" class="bg-light py-5">
  	...
  	<section id="find" class="bg-light py-5">
	    <div class="container">
	      	...
	      	<form id="find_name" method="GET" action="FindStudent">
	      		<div class="form-group">
	      		</div>
	      		<div class="form-group">
	      		</div>
				...
				<input class="btn btn-primary my-2 find_submit" type="submit" value="Find"/>
			</form>
	    </div>
	  </section>
	   </div>
	   ...
	   <section id="remove" class="bg-light py-5">
	    <div class="container">
	      	...
	      	<form id="remove_student" method="GET" action="RemoveStudent">
	      		<div class="form-group">
				...
				<input class="btn btn-danger my-2 removed" type="submit" value="Remove"/>
			</form>
	    </div>
	  </section>
	  </div>
	...
	<script>
  	$(document).ready(function () {
  		...
  		$(".find_submit").click(function (e) {
  			...
  			$.ajax({
  	  		  type: 'GET',
  	  		  url: $("#find_name").attr("action"),
  	  		  data: $("#find_name").serialize(),
  	  		  success: function(response) { 
  	  			  alert(response);
  		...
  		$(".removed").click(function (e) {
  			...
  			$.ajax({
  	  		  type: 'GET',
  	  		  url: $("#remove_student").attr("action"),
  	  		  data: $("#remove_student").serialize(),
  	  		  success: function(response) { 
  	  			  alert(response);
  	  			  location.reload();
  	  		  },
